...
> Stand: 18.07.2026 (Workbook Block-Designregeln abgenommen: Abschnitt 8 in design-system.md final, Block-Renderer und Schritt-Kopf unter /programme/ifs umgebaut. Nächster Schritt: Auftrag 3, Blocktypen table, wordlist, audio. Branch feature/workbook). Diese Zeile bei jedem live gegangenen Feature mit aktualisieren.
...
6. Digitales IFS-Workbook für Klienten. Auftrag 1 (Fundament), Auftrag 2 (Block-Renderer, Routen, Autosave, lesende Sperrlogik, Fortschritt) und die Block-Designregeln (Abschnitt 8 in design-system.md, Umbau von freetext/scale/choice und Schritt-Kopf) sind auf feature/workbook abgenommen, Details in workbook-konzept.md. Nächster Schritt: Auftrag 3 (Blocktypen table, wordlist, audio). Entwicklung ausschließlich auf dem Branch feature/workbook, Merge auf main erst nach MVP-Abschluss.

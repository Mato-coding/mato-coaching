...
> Stand: 18.07.2026 (Workbook Auftrag 2 abgenommen, getestet am 18.07.2026: Block-Renderer, Routen, Autosave, lesende Sperrlogik, Fortschritt. Nächster Schritt: Block-Designregeln in design-system.md, danach Auftrag 3. Branch feature/workbook). Diese Zeile bei jedem live gegangenen Feature mit aktualisieren.
...
6. Digitales IFS-Workbook für Klienten. Auftrag 1 (Fundament) und Auftrag 2 (Block-Renderer, Routen, Autosave, lesende Sperrlogik, Fortschritt) sind auf feature/workbook abgenommen (Auftrag 2 getestet am 18.07.2026), Details in workbook-konzept.md. Nächster Schritt: Block-Designregeln als eigener Abschnitt in design-system.md definieren, danach Auftrag 3 (Blocktypen table, wordlist, audio). Entwicklung ausschließlich auf dem Branch feature/workbook, Merge auf main erst nach MVP-Abschluss.

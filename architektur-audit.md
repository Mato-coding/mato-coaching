...
**Noch offen (Auftrag 5, siehe Abschnitt 3):** Header/Footer-Client-Grenze (Kandidat 7), restliche `border-primary/N`-Fundstellen außerhalb von `/breathwork`, `/coaching` und den jetzt migrierten Karten (Kandidat 5), Typisierungs- und lib-Befunde (Abschnitt 2.7, außer dem jetzt behobenen `BreathworkAbout.tsx`-Befund C).

...
**Noch offen (Aufträge 4 und 5, siehe Abschnitt 3):** Metadata/JSON-LD-Vereinheitlichung (Kandidat 4), Header/Footer-Client-Grenze (Kandidat 7), restliche `border-primary/N`-Fundstellen außerhalb von `/breathwork` und `/coaching` (Kandidat 5), Typisierungs- und lib-Befunde (Abschnitt 2.7, außer dem jetzt behobenen `BreathworkAbout.tsx`-Befund C).

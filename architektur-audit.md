...
**Noch offen (Aufträge 3 bis 5, siehe Abschnitt 3):** `/coaching`-Extraktion (Kandidat 3, Befund A2), Metadata/JSON-LD-Vereinheitlichung (Kandidat 4), Header/Footer-Client-Grenze (Kandidat 7), restliche `border-primary/N`-Fundstellen außerhalb von `/breathwork` (Kandidat 5), Typisierungs- und lib-Befunde (Abschnitt 2.7, außer dem jetzt behobenen `BreathworkAbout.tsx`-Befund C).

...
Pflegehinweis: Abschnitte 5 bis 8 (Angebot, Ziele, Zielgruppe, Kanäle) ändern sich am häufigsten, etwa quartalsweise prüfen. Abschnitte 1 bis 4 nur bei neuen Ausbildungen oder Stationen. Offene Felder sind mit [offen] markiert.

---

## 1. Person

- Lasse Klüver, geboren 1980, 45 Jahre, Hamburg.
- Wirtschaftsingenieur, klassische Generalistenkarriere mit mehrjährigen Stationen vom Konzern (Airbus) bis zum Kleinst-Start-up.
- Seit 6 Jahren selbstständig als Freelancer mit Fokus auf Vertrieb, Organisations- und Teamentwicklung.
- Arbeitet auf Deutsch und Englisch. Hamburg und Umgebung, remote oder vor Ort. Aktuell kein eigener fester Raum.

## 2. Qualifikation

- Zertifizierter Breathe to Heal Facilitator nach Max Strom.
...
Lange Distanz zur indisch und Sanskrit geprägten Kultur der Yogaszene. Die damalige Partnerin nahm ihn mit zu einem Breathwork-Retreat von Max Strom, dort sofortiger Zugang zur Arbeit: Sie wirkt unmittelbar und tiefgehend und verbindet emotionale und leicht spirituelle Arbeit mit klaren physiologischen Fakten. Kernfaszination: die Zusammenhänge zwischen emotionalen und körperlichen Symptomen. Die somatische Arbeit verbindet sein Körperwissen mit den emotionalen Themen, deshalb ist sie für ihn so schlüssig und wirksam.

Ton für die Nutzung in Copy: bodenständig, physiologisch fundiert, unaufgeregt spirituell offen. Kein Guru-Framing, keine Esoterik-Sprache.

## 4. Aktuelle Arbeit

- Hauptformat: Gruppensessions von 75 bis 90 Minuten, 5 bis 30 Personen, in verschiedenen Studios (dort als Lehrer gelistet).
- Seltener: Workshop-Formate über 2 bis 3 Tage.
- Retreats: bisher 5, in Deutschland, auf Mallorca und Ibiza.
...
Primäre Wunschklientel (aus realen Kursteilnehmern abgeleitet):

- Gründer mit Anxiety-Themen: das Unternehmen läuft auf Volldampf, er selbst läuft auf Reserve und kommt nicht mehr zur Ruhe.
- Führungskraft mit Familie: außer der Arbeit bekommt nichts mehr die Energie, die es verdient, inklusive Partner und Kindern. Kaum noch Freude, vor allem Funktionieren.

Weitere genannte Gruppen (Priorität ungeklärt, siehe Abschnitt 10):

- Menschen in Krise und Umorientierung.
- Paare in Trennung.
- Menschen in Trauersituationen, Sterbe- und Trauerbegleitung.
- Coaching im Rahmen von AVGS-Gutscheinen.

Ausschlüsse: keine benannt.

## 8. Ergebnisse in Teilnehmerworten (Rohmaterial für Copy)
...
Diese Punkte sind dokumentiert, damit sie nicht in jeder Diskussion neu aufkommen. Sie sind bewusst noch nicht entschieden:

1. Zielgruppenfokus: Die Liste in Abschnitt 7 ist breit (Leistungsträger mit Anxiety, Trauerbegleitung, Paare in Trennung, AVGS). Die Website positioniert aktuell auf stressbedingte innere Unruhe bei zahlungskräftigen Menschen. Empfehlung in Arbeit: Fokus auf die ersten beiden Personas, weitere Gruppen als stille Kompetenz ohne eigene Positionierung.
2. AVGS: staatlich vergütet und formalisiert, steht in Spannung zum Premium-Programm um 4.000 Euro. Entscheidung nötig, ob und wie das ins Portfolio passt, bevor es irgendwo sichtbar wird.
3. Retreats: bestehendes Asset (5 durchgeführt, Mallorca, Ibiza), aber noch ohne Rolle im Funnel und in der Angebotsarchitektur.
4. Zweisprachigkeit: Arbeit auf Deutsch und Englisch vorhanden, Website ist rein deutsch. Vorerst kein Handlungsbedarf, bei internationaler Nachfrage neu bewerten.

## 11. Grenzen und Ton

- Keine erfundenen oder aufgeblähten Erfahrungswerte. Keine Klientenzahlen behaupten, die es nicht gibt. Autorität über Präzision, Qualifikation und Klarheit, nicht über Behauptung.
- Anfänger-Signale vermeiden, ohne zu übertreiben: reale Lehrtätigkeit, reale Ausbildungen und Lehrer nennen, Fehlendes weglassen.
- Ton: ruhig, klar, körperlich fundiert, unaufgeregt. Passend zu Quiet Luxury und den Copy-Regeln in CLAUDE.md.
- Keine weiteren No-Gos benannt. [offen] Bei Bedarf ergänzen.
